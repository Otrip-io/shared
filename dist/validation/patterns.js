...
exports.USERNAME_REGEX = /^(?=[a-z0-9._]{5,20}$)(?!.*[._]{2})[a-z0-9][a-z0-9._]*[a-z0-9_]$/;
exports.USERNAME_MESSAGE = 'Username must be 5-20 characters: lowercase letters, numbers, dots, underscores. No consecutive dots/underscores';
